...
fprintf('The performance of two-class class 0 against the rest on handwritten digit data set is %.2f\n',p1);
fprintf('The performance of two-class class 1 against the rest on handwritten digit data set is %.2f\n',p2);
fprintf('The performance of two-class class 2 against the rest on handwritten digit data set is %.2f\n',p3);
