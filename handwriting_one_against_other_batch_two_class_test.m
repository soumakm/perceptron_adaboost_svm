...
for i=1:n
    ...
    a12 = batch_perceptron_one_against_other(x1, x2, a0, eta1, b);
    a13 = batch_perceptron_one_against_other(x1, x3, a0, eta2, b);
    a23 = batch_perceptron_one_against_other(x2, x3, a0, eta3, b);
